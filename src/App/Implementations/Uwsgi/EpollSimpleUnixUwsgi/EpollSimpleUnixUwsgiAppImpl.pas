 ...
 *}
unit EpollSimpleUnixUwsgiAppImpl;
...
type
     ...
     *-----------------------------------------------*)
    TEpollSimpleUnixUwsgiWebApplication = class(TBaseSimpleUwsgiWebApplication)
    public
...
uses
     ...
     * default service provider
     *-----------------------------------------------*)
    constructor TEpollSimpleUnixUwsgiWebApplication.create(
        const socketFilename : string;
        const container : IDependencyContainer = nil;
        const errHandler : IErrorHandler = nil;
        const dispatcherInst : IDispatcher = nil
